...
// DARK
Color darkScaffoldBackgroundColor = Colors.grey.shade900;
Color darkBodyTextColor = const Color(0xFFE4E9F2);
// LIGHT
Color lightScaffoldBackgroundColor = Colors.white;
Color lightBodyTextColor = const Color(0xFF333333);

Color primaryScolor = const Color(0xFF00AB6B);
